...
def calculate_three_metric(preds, labels):
    ...
    auc = roc_auc_score(labels_np, preds_np, average='macro', multi_class='ovr')  # AUC

    # Calculate SPE and SEN one by one then average
